...
#Initilization of root and base widgets
    def __init__(self, master):
        ...
        self.maincanvas_pic=Image.open("C:\\Users\\alext\\OneDrive\\Desktop\\VisualStudioCode\\Completed_projects\\URL Toolkit Folder\\Mainpage.png")
        self.maincanvas_pic = self.maincanvas_pic.resize((740,675))
        output_path = os.path.join("URL Toolkit Folder", "Mainpage-re.png")
        os.makedirs(os.path.dirname(output_path), exist_ok=True)
        self.maincanvas_pic.save(output_path)
        self.maincanvas_pic = ImageTk.PhotoImage(Image.open(output_path))
    ...
    def shorten_help(self):
        ...
        self.shortenhelp_pic = ImageTk.PhotoImage(Image.open("URL Shortener Helpful Tips.png"))
    ...
    def shorten_window(self):       
        ...
        self.Q_pic=Image.open("Question Mark.png")
        self.Q_pic = self.Q_pic.resize((30,30))
        self.Q_pic.save("Question-Mark-resized.png")
        self.Q_pic=ImageTk.PhotoImage(Image.open("Question-Mark-resized.png"))
    ...
    def QR_help(self):
        ...
        self.QRhelp_pic = ImageTk.PhotoImage(Image.open("QR Generator Helpful Tips.png"))
    ...
    def expand_event(self):
        if self.radio_var.get()==1:
            self.orange_example_f2=Image.open("Orange Flyer Example.PNG")
            self.orange_example_f2.show()
        elif self.radio_var.get()==2:
            self.blue_example_f2=Image.open("Blue Image Example.PNG")
            self.blue_example_f2.show()
        elif self.radio_var.get()==3:
            self.dark_example_f2=Image.open("Dark Flyer Example.PNG")
    ...
    def flyer_help(self):
        ...
        self.fhelp_pic = ImageTk.PhotoImage(Image.open("Flyer Helpful Tips.png"))
    ...
    def orange_template(self):
        self.ot_img = Image.open("Orange & White Elegant Business Flyer Potrait (2).png")
        self.orange_blank = Image.open("Orange Blank.png")
        self.orange_blank = self.orange_blank.resize((500,500))
        self.header_img = self.file_image.resize((500,500))
        self.header_img.save("Header Img.jpg")
        ...
        self.header_img2.save("composite_circle.png", quality=95)
        self.header_img2 = Image.open("composite_circle.png")       
    ...
    def blue_template(self):
        self.bt_img = Image.open("Light Blue Purple Simple Gradient Travel Poster (2).png")
    ...
    def dark_template(self):
        self.dt_img = Image.open("Black And Brown Geometric Business Flyer (1).png")
        self.black_blank = Image.open("Black Blank.png")
        ...
        self.header_img2.save("composite_circle_B.png", quality=95)
        self.header_img2 = Image.open("composite_circle_B.png")       
    ...
    def flyer_window(self):
        ...
        self.anonymous_pic=Image.open("gray_anonymous.png")
        self.anonymous_pic = self.anonymous_pic.resize((100,100))
        self.anonymous_pic.save("gray_anonymous.png")
        self.anonymous_pic=ImageTk.PhotoImage(Image.open("gray_anonymous.png"))
        #Add image to the Canvas Items
        ...
        self.expand_pic=Image.open("expand arrow.png")
        self.expand_pic = self.expand_pic.resize((10,10))
        self.expand_pic.save("expand arrow.png")
        self.expand_pic=ImageTk.PhotoImage(Image.open("expand arrow.png"))
